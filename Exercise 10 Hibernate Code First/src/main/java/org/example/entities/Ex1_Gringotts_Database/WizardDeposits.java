package org.example.entities.Ex1_Gringotts_Database;
...
public class WizardDeposits extends BaseEntity {
    ...
    private Boolean isDepositExpires;
    ...
    public Boolean getDepositExpires() {
        return isDepositExpires;
    }

    public void setDepositExpires(Boolean depositExpires) {
        isDepositExpires = depositExpires;
    }
}
